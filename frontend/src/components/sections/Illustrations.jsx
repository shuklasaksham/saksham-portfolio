...
export default function Illustrations() {
  return (
    <section className="md:h-full w-full md:overflow-hidden px-4 sm:px-6 md:px-10 lg:px-12 py-4 md:py-6 flex flex-col">
      ...
      <article className="rounded-sm p-4 sm:p-5 md:p-6 flex flex-col md:flex-1 md:min-h-0 md:overflow-hidden" style={{ border: '1px solid var(--amber)' }}>
        ...
        <div className="md:flex-1 md:min-h-0 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2 md:overflow-hidden">
          {digitalArt.map((a) => (
            <figure key={a.id} className="relative rounded-sm overflow-hidden group aspect-square md:aspect-auto md:h-full md:min-h-0" style={{ border: '1px solid rgba(245,165,36,0.5)' }}>
